<div class=" text-gray-100">
    ...
    <div class="flex flex-col mx-auto"> 
        {{-- <form action="" wire:submit="searching"> --}}
            <input type="text" wire:model.live="search" class="border p-1 px-2 w-2/3 mx-auto border-gray-100 block h-12 py-1 rounded"name="title" id="title">
    ...
    @endforeach
    @if ($articles->count() < $this->countTotalArticles)
